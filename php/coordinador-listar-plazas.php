...
<body>
    <div class="pagina-contenedor">
        ...
        <div id="menu-lateral" class="menu-lateral">
            <ul>
                <li><a href="administracion.html"><span class="icono-menu icono-usuario"></span> Usuario</a></li>
                <li><a href="../html/coordinador.html"><span class="icono-menu icono-menu"></span> Menú principal</a></li>
                <li><a href="#"><span class="icono-menu icono-salir"></span> Cerrar sesión</a></li>
                        ...
                        <div class="panel-cuerpo">
                            ...
                            <div class="tabla-responsive">
                                <table class="tabla">
                                    ...
                                    <tbody>
                                    <?php include 'consulta-coordinador-listar-historial-plazas.php'; ?>
                                    </tbody>
                                </table>
                            </div>
                        </div>
