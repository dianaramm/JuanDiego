...
<body>
            ...
            <div class="contenedor">
                ...
                <div class="panel seccion-ficha">
                    ...
                    <div class="panel-cuerpo">
                        <!-- Aquí está el formulario con el campo oculto -->
                        <form class="formulario-planeacion" method="post"
                            action="consulta-coordinador-planeacion-anual.php">
                            <!-- Campo oculto para la acción -->
                            <input type="hidden" name="accion" value="guardar_planeacion">

                            <div class="campo-formulario">
                                <label for="nombre-planeacion">Nombre de planeación</label>
                                <input type="text" id="nombre-planeacion" name="nombre-planeacion" required>
                            </div>
    ...
    <script src="../js/coordinador-guardar-planeacion-anual.js"></script>
